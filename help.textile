...
@parent_link_class="class name"@

- the class to be used on section @<a>@ that are parents. Default = "".

@sub_menu_class="class name"@

- class applied to all submenu @<ul>@. Default = "".
